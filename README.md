...
## Society Ledger Manager
This is a collection of scripts for managing your society's ledger. You can find instructions for getting started in [`INSTRUCTIONS.md`](society-ledger-manager/INSTRUCTIONS.md).
